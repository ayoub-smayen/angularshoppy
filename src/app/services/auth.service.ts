...
export class AuthService {
  ...
  login(username, password) {
    return this.http.post('http://localhost:8091/api1/auth/login', { username: username, password: password });
  }
  ...
  editProfile(p:Profile){
    ...
    return this.http.put("http://localhost:8091/api1/user/editprof",p,httpOptions);
  ...
  getCuurentUser() : Observable<User>{
    ...
    return this.http.get<User>("http://localhost:8091/api1/auth/cuurentUser",httpOptions);
  ...
  register(username,email, password) {
    return this.http.post('http://localhost:8091/api1/auth/register', { username: username, email:email,password: password });
  }
